 ...
 * to all units within a 300px diameter circle (radius 150) at the center.
 */
export function handleMeteorAttack(params: {
  ...
  // Calculate start (above) and target (center) positions
  ...
  // Create a meteor graphic: a circle with radius 150 (diameter 300px)
  ...
  // Create and push the meteor effect
